        ...
        <div className="min-h-screen grid w-full items-center bg-zinc-900 px-4 font-mono text-sm text-white">
            <SignUp.Root>
                ...
                >
                    ...
                    <SignUp.Action submit className="w-full px-4 py-2 bg-yellow-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-0.5 active:shadow-none text-black font-bold uppercase">
                        Sign Up
                    </SignUp.Action>
